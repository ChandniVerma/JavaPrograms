...
public class Demo1 {
	public static void main(String[] args) {
		...
		Integer[][] array= {
				...
				{193,	281,	2976,	3009,	626,	152	,	1185	,3332	,715	,1861	,186	,1768	,3396	,201	,3225},
				{492,	1179,	154,	1497,	819,	2809	,2200,	2324,	157	,2688,	1518,	168	,2767,	2369,	2583	,173},
				{286,	2076,	243,	939,	399,	451	,231	,	2295,	453	,1206	,2468	,2183	,230	,714,	681},
				{3111,	2857,	2312,	3230,	149,	3082,	408	,1148,	2428,	134	,147	,	128,	157,	492,	2879}
				...
				List list=new ArrayList();
				 ...
				 System.out.println("insort"+list);
				  min=(int) list.get(0);
				  System.out.println(min);
				  max=(int) list.get(list.size()-1);
				 ...
				 //System.out.println(list.get(k1));
				 }
